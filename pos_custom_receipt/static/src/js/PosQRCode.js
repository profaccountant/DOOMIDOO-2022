odoo.define('pos_qr_code.OrderReceipt', function (require) {
    'use strict';
    ...
    const PosQRCodeOrderReceipt = OrderReceipt =>
        class extends OrderReceipt {
            mounted() {
                ...
                if (this.env.pos.config.show_qr_code) {
                    new QRCode(document.getElementById("qrcode"), {"text": this._receiptEnv.receipt.qr_code ,width:200, height:200, correctLevel : QRCode.CorrectLevel.L});
